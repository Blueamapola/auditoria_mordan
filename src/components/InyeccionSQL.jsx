function InyeccionSQL() {
  return (
    <section className="bg-white rounded-lg shadow-md mb-8" style={{borderTop: '4px solid #EF4444'}}>
      <div className="p-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <img src="/img_mordan/sqli_mordan.png" alt="SQLi" className="border border-slate-200 rounded-md w-full mb-4 shadow-sm" />
